...
CREATE TABLE IF NOT EXISTS `printers` (
	...
	`birthyear`	INTEGER,
	`deathyear`	INTEGER,
	`printer_othername1`	TEXT,
	`printer_othername2`	TEXT,
	`description`	TEXT
);
...
INSERT INTO `printers` (`printer_id`, `printer_name`, `birthyear`, `deathyear`, `printer_othername1`, `printer_othername2`, `description`) VALUES (0, "Aldo Manuzio", 1450, 1515, "Aldus Manutius", "Alde Manuce", "Alde Manuce est un imprimeur-libraire italien installé à Venise, qui a joué un rôle fondamental dans la diffusion de la culture humaniste de la Renaissance dans la péninsule italienne, et particulèrement de la littérature grecque. [Wikipedia]");
INSERT INTO `printers` (`printer_id`, `printer_name`, `birthyear`, `deathyear`, `printer_othername1`, `printer_othername2`, `description`) VALUES (1, "Paulo Manucio", 1512, 1574, "Paulus Manutius", "Paul Manuce", "Paul Manuce est un imprimeur et humaniste vénitien, fils d'Alde Manuce. [Wikipedia]");
INSERT INTO `printers` (`printer_id`, `printer_name`, `birthyear`, `deathyear`, `printer_othername1`, `printer_othername2`, `description`) VALUES (2, "Aldo Manuzio", 1547, 1597, "Aldus Manutius", "Alde le Jeune", "Aldo Manuzio, dit le Jeune, est un imprimeur vénitien. Il était le fils de Paolo Manuzio, et petit-fils de Alde l'Ancien. [Wikipedia]");
INSERT INTO `printers` (`printer_id`, `printer_name`, `birthyear`, `deathyear`, `printer_othername1`, `printer_othername2`, `description`) VALUES (3, "Andrea Torresano", 1451, 1529, "Andreas Asulanus", "Andrea Asolano", "Andrea Torresano est un imprimeur italien, citoyen de la république de Venise. A la mort d'Alde, en 1515, il continue à diriger la société au nom de ses fils, tous mineurs. [Wikipedia]");
